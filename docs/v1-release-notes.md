...
No GCP credentials, cloud services, database, external identity provider, container runtime, deployment target, or non-loopback runtime service is needed to build or accept v1.
