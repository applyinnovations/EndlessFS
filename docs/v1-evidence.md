...
| Bounded large-directory list/grid DOM, exactly eleven 1,000-entry pages for the 10,003-entry fixture, bounded preview requests, zero redundant terminal-operation polls, zero provider calls for 10,000 restored transfer records, and deterministic filter work | `TestE2EBrowserBootstrapLoginDriveShareAndTrash`, `TestE2ERestoringTenThousandTransfersDoesNotBlockWorkspaceOrPollUploads`; `nix run .#test-ui-benchmark` (`ui-benchmark-v1` JSON-line evidence) |
