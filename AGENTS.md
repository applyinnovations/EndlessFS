...
Implement the complete mock-backed v1 specification in milestone order without weakening its security or reproducibility requirements. The repository currently contains a Milestone 0 scaffold, not a working drive and not a production storage provider. Never present an unimplemented placeholder or empty test selection as v1 evidence.
